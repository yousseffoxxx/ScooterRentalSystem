...
namespace ScooterRental.Persistence.Data.Migrations
{
    ...
    [Migration("20260620081654_add DeviceSecretKey column to the scooter table")]
    partial class addDeviceSecretKeycolumntothescootertable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ScooterRental.Domain.Models.Auth.User", b =>
                {
                    ...
                    b.Property<string>("IdBackPhotoUrl")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.Property<string>("IdFrontPhotoUrl")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.Property<string>("IdRejectionReason")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ScooterRental.Domain.Models.Payment.WalletTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ScooterRental.Domain.Models.Payment.WalletTransaction", b =>
                {
                    b.HasOne("ScooterRental.Domain.Models.Payment.Wallet", "Wallet")
