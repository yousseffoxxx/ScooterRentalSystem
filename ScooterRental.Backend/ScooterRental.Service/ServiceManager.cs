namespace ScooterRental.Service
{
    public class ServiceManager(UserManager<User> _userManager, ITokenService _tokenService, IConfiguration _configuration,
        ...
        IAiVerificationService _aiVerificationService, IRealTimeBroadcastService _broadcastService)
        : IServiceManager
    {
        ...
        private readonly Lazy<IRideService> _lazyRideService = new Lazy<IRideService>(() => new RideService(_unitOfWork, _mqttCommandService, _scooterTelemetryRepository, _zoneCacheService, _userManager, _notificationService, _activeRideCacheRepository, _localStorageService, _configuration));
