...
{
    public class ZoneForCreationDtoValidator : AbstractValidator<ZoneForCreationDto>
    {
        public ZoneForCreationDtoValidator()
        {
            RuleFor(z => z.Name)
            ...
            RuleFor(z => z.SpeedLimitKmH)
                .NotEmpty().WithMessage("If provided, the speed limit must be between 0 and 60 km/h.")
